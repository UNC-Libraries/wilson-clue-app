<div class="form-group col-12 col-sm-4">
    ...
    <select name="suspect_id" id="solutionSuspect" class="form-control form-select">
...
<div class="form-group col-12 col-sm-4">
    ...
    <select name="location_id" id="solutionPortal" class="form-control form-select">
...
<div class="form-group col-12 col-sm-4">
    ...
    <select name="evidence_id" id="solutionEvidence" class="form-control form-select">
